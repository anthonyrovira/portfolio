import AnimatedSection, {
  fadeIn,
  zoomIn,
} from "../../ui/animations/AnimatedSection";
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 w-full absolute inset-0 max-w-7xl flex flex-row items-start justify-center gap-5">
        <div className="w-full h-full flex flex-row justify-center items-center mt-auto">
          ...
          >
            ...
            <h1 className="flex flex-col text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
              <span className="relative w-max">
                ...
                <span className="relative bg-linear-to-r dark:from-white dark:via-blue-100 dark:to-purple-200 text-text-light_secondary bg-clip-text dark:text-transparent">
                  Anthony
                </span>
              </span>
            ...
            <div className="h-8 flex items-center" data-aos="fade-up">
              <span className="sm:text-xl md:text-2xl bg-linear-to-r dark:from-gray-100 dark:to-gray-300 bg-clip-text dark:text-transparent text-text-light_secondary font-light">
                {text}
              </span>
              <span className="w-1 h-6 bg-linear-to-t from-[#6366f1] to-[#a855f7] ml-1 animate-blink" />
            </div>
          ...
          <AnimatedSection
            ...
            viewport={{ once: true }}
          >
            <div className="w-64 h-64 sm:w-75 sm:h-75 md:w-130 md:h-130 relative">
              ...
              <div className="w-full h-full flex items-center justify-center relative z-10">
                <div className="w-full h-full rounded-lg relative overflow-hidden">
                  <video
                    ...
                    playsInline
                    controls={false}
                    className="w-130 md:h-137.5"
                  >
                    <source
                      src="/media/coding-illustration.webm"
                      type="video/webm"
                    />
                  </video>
