...
const CareerTimeline = ({ experiences }: CareerTimelineProps) => {
  return (
    <div className="relative w-full mb-80 mx-auto">
      {/* Central timeline line */}
      <motion.div
        className="absolute hidden lg:block left-1/2 w-1 bg-linear-to-b from-[#6366f1] via-blue-900 to-[#a855f7] h-[115%] blur-[2px] -translate-x-1/2"
