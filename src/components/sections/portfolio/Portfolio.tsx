      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-10 my-20 sm:mt-8 md:mt-12">
        ...
        >
          ...
          <div className="flex items-center gap-2 ">
            ...
            <p className="dark:text-white/70 text-pretty text-center mx-auto text-text-light_secondary text-base sm:text-lg wrap-break-word max-w-3xs sm:max-w-lg md:max-w-2xl">
