...
const TimelineCard = ({
  ...
  return (
    <motion.div
      ...
      className={clsx(
        "w-full",
        index % 2 === 0 ? "lg:translate-y-0" : "lg:translate-y-60",
      )}
    >
      <div
        className={clsx(
          "relative w-full max-w-full group",
      ...
      >
        ...
        <motion.div
          className={clsx(
            "absolute hidden lg:block top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-linear-to-br saturate-40 shadow-lg z-10",
            color,
        ...
        >
          ...
          <div
            className={clsx(
              ...
              "absolute inset-0 bg-linear-to-br opacity-50 group-hover:opacity-70 dark:opacity-10 dark:group-hover:opacity-20 transition-opacity duration-300 rounded-2xl",
              color,
            )}
          />
          ...
          <div className="relative z-10 space-y-2 sm:space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="text-base text-text-light_secondary dark:text-gray-400">
                  {experience.position}
                </div>
              </div>
            </div>
            ...
            {/* Description */}
            <p className="text-text-light dark:text-gray-300 text-pretty text-justify text-base">
            ...
            <ul className="space-y-1">
              {experience.bulletPoints.map((point, i) => (
                <li key={i} className="flex items-start ">
                  <span
                    className={`min-w-2 min-h-2 mt-2 mr-2 bg-linear-to-br ${color} saturate-40 rounded-sm`}
                  />
                  <span className="text-base text-pretty text-text-light dark:text-gray-300 ">
                    {point}
                  </span>
                </li>
              ))}
